...
typedef std::tuple<Image,  std::vector<std::vector<float> > >  NastyStackElement;

void ImageStack::push(const Image& img, const std::vector<std::vector<float> > &mask){
